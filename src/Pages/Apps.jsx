...
const Apps = () => {
  ...
  const [searching, setSearching] = useState(false); // Search loader state
  ...
  const handleSearch = (e) => {
    ...
    setSearching(true);
    // simulate small delay for search loader
    setTimeout(() => setSearching(false), 200); // 200ms delay for UX
  };
              ...
              <div className="card bg-base-300 border shadow-sm hover:scale-105 transition ease-in-out p-4">
                ...
                <div className="py-4">
                  ...
                  <div className="flex justify-between items-center pt-5">
                    ...
                    <button
                      className={`btn rounded text-xl bg-[#f6e1cd] text-[#FF8811] flex items-center gap-1 ${
